...
<style>
    ...
    .trusted-by li {
        flex: 1 1 100px;
        /* Ensures images shrink on smaller screens */
        max-width: 120px;
        /* Controls the max size */
        display: flex;
        justify-content: center;
    }
    ...
    .trusted-by img {
        width: 100%;
        /* Ensures the image fits its container */
        height: auto;
        /* Keeps aspect ratio */
        max-height: 100px;
        /* Controls height */
        ...
        <div class="row py-lg-5">
            <div class="col-lg-8 m-auto ">
                <div class="homepage-search-title">
                    ...
                    <h5 class="mb-5 text-shadow text-white-50 font-weight-normal" style="text-align: center; color: white !important;">Countless individuals utilize BGG Entertainment to bring their concepts to life..</h5>
                </div>
...
<!--       social -->
<ul class="trusted-by">
    <li><img src="{{ asset("assets/images/sponsors/sponsor1.jpg") }}"></li>
    <li><img src="{{ asset("assets/images/sponsors/sponsor2.jpg") }}"></li>
    <li><img src="{{ asset("assets/images/sponsors/sponsor3.jpg") }}"></li>
    <li><img src="{{ asset("assets/images/sponsors/sponsor4.jpg") }}"></li>
