...
<body>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="position-relative icon-form-control">
                                    ...
                                    <i class="mdi mdi-eye position-absolute" style="right: 10px; top: 10px; cursor: pointer;" onclick="togglePassword('confirm_password')"></i>
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-success btn-block text-uppercase" style="color: black;">JOIN AS A FREELANCER</button>
                            <!-- <button type="button" class="btn btn-success btn-block text-uppercase" style="color: black;" onclick="setRole('client')">JOIN AS A CLIENT</button> -->
    ...
    <script>
        ...
        //     document.getElementById('registerForm').submit(); // Submit the form here
        // }
    </script>
