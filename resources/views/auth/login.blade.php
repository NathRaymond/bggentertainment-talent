                ...
                <div class="col-lg-4 mx-auto">
                    <div class="osahan-login py-4">
                        <div class="text-center mb-4">
                            ...
                            <h5 class="font-weight-bold mt-3">Sign in to your account</h5>
                            <p class="text-muted">Stay connected to your professional world. Sign in now and never miss your next opportunity.</p>
                        </div>
                        <form action="#">
                            ...
                            <!-- <div class="text-center mt-3 border-bottom pb-3">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <button type="button" class="btn btn-outline-instagram btn-block"><i class="mdi mdi-google"></i> Instagram</button>
                                    </div>
                                    <div class="col-6">
                            ...
                            <div class="py-3 d-flex align-item-center">
                                ...
                                <span class="ml-auto"> Don’t have an account? <a href="{{route("register")}}">Join here </a></span>
                            </div>
                        </form>
                    </div>
                </div>
