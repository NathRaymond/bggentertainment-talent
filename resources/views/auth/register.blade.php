                ...
                <div class="col-lg-5 mx-auto">
                    <div class="osahan-login py-4">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <!-- Hidden input field for user_type -->
                            ...
                            <!-- Buttons -->
                            <button type="submit" class="btn btn-success btn-block text-uppercase" style="color: black;" onclick="setRole('freelancer')">JOIN AS A FREELANCER</button>
                            <button type="submit" class="btn btn-success btn-block text-uppercase" style="color: black;" onclick="setRole('client')">JOIN AS A CLIENT</button>
