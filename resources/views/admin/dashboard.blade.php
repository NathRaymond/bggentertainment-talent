                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img src="{{ asset("admin-assets/images/users/avatar-1.jpg") }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img src="{{ asset("admin-assets/images/users/avatar-2.jpg") }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img src="{{ asset("admin-assets/images/users/avatar-4.jpg") }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img src="{{ asset("admin-assets/images/users/avatar-6.jpg") }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
