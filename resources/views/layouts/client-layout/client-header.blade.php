                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownPortfolio">
                        ...
                        <div class="dropdown-submenu">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownSubmenu">
                                <a class="dropdown-item" href="{{route("bank.details")}}">Banking Services</a>
                                <a class="dropdown-item" href="{{route("hospitality.details")}}">Hospitality Services</a>
                                <a class="dropdown-item" href="{{route("hr.details")}}">HR</a>
                                <a class="dropdown-item" href="{{route("payroll.details")}}">Payroll</a>
                                <a class="dropdown-item" href="{{route("tax.details")}}">Tax Services</a>
                                <a class="dropdown-item" href="{{route("travel.details")}}">Travel Services</a>
                                <a class="dropdown-item" href="{{route("vendor.details")}}">Vendor Services</a>
                                <a class="dropdown-item" href="{{route("health.details")}}">Healthcare Services</a>
                                <a class="dropdown-item" href="{{route("training.details")}}">Training Services</a>
                            </div>
