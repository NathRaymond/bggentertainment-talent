...
<div class="navbar-brand-box">
    ...
    <a href="index.html" class="logo logo-dark">
        <span class="logo-sm">
            <img src="{{ asset("assets/images/bgg_logo.avif") }}" alt="" height="50">
        </span>
        <span class="logo-lg">
            <img src="{{ asset("assets/images/bgg_logo.avif") }}" alt="" height="50">
        </span>
        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                    <i class="ri-apps-2-line"></i> <span data-key="t-apps">Configurations</span>
                </a>
                <div class="collapse menu-dropdown" id="sidebarApps">
                    <ul class="nav nav-sm flex-column">

                        <li class="nav-item">
                            <a href="{{ route("category.index") }}" class="nav-link" data-key="t-chat"> Manage Category </a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link" data-key="t-chat"> Manage Subcategory </a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                    <i class="ri-account-circle-line"></i> <span data-key="t-authentication">Manage User</span>
                </a>
