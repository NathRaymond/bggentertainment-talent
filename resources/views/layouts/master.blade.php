...
<body>
    ...
    <script src="{{ asset("assets/js/jqBootstrapValidation.js") }}" type="ccf84049af8c6be94fbc0c05-text/javascript"></script>
    <script src="{{ asset("assets/js/contact_me.js") }}" type="ccf84049af8c6be94fbc0c05-text/javascript"></script>
    <!-- Slick -->
