    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="mt-0 mb-3 text-white">Healthcare Services</h1>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="filters-card-body card-shop-filters">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="cb2">Healthcare Services</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                    ...
                    <div class="col-md-4">
                        <div class="inner-slider" style="border-top: 1px solid #ccc; padding: 5px; background-color: #f9f9f9; border-radius: 10px;">
                            <div class="inner-wrapper" style="max-width: 800px; margin: 0 auto; text-align: center;">
                                <a href="#">
                                    <img class="img-fluid" src="{{ asset('assets/images/sponsors/health.webp') }}" />

                                </a>
                                <div>
                                    <a href="https://www.ekohotels.com/" target="_blank" style="text-decoration: none; color: #333;">
                                        <span style="display: block; margin-bottom: 10px;">
                                            <h2 style="font-size: 24px; font-weight: bold; color: #405189;">IMPACT Healthcare</h2>
                                ...
                                <div>
                                    <h3 style="background-color: #405189; padding: 15px; color: white !important; font-weight: bold; border-radius: 5px;">
                                        Impact Healthcare is a consulting company specialising in Emergency Medicine advice for setting up and operating Emergency Centres in the private sector.
                                    </h3>
                                </div>
                            </div>
                        </div>
