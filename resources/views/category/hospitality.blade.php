    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="mt-0 mb-3 text-white">Hospitality</h1>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="filters-card-body card-shop-filters">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="cb2">Hospitality Services</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                ...
                                <div>
                                    <a href="https://www.ekohotels.com/" target="_blank" style="text-decoration: none; color: #333;">
                                        <span style="display: block; margin-bottom: 10px;">
                                            <h2 style="font-size: 24px; font-weight: bold; color: #405189;">Eko Hotel</h2>
