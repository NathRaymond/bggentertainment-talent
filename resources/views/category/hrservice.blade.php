    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="mt-0 mb-3 text-white">HR Services</h1>
    ...
    <div class="container">
        <div class="row">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="filters-card-body card-shop-filters">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="cb2">HR Services</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="cb1">
                                            <label class="custom-control-label" for="cb1">HR, Payroll, and Tax Services </label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="cb3">
                                            <label class="custom-control-label" for="cb3">Travel Services</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="cb4">
                                            <label class="custom-control-label" for="cb4">Vendor Services</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="cb3">
                                            <label class="custom-control-label" for="cb3">Healthcare Services</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="cb3">
                                            <label class="custom-control-label" for="cb3">Banking Services</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="cb3">
                                            <label class="custom-control-label" for="cb3">Training Services</label>
                                        </div>
            ...
            <div class="col-lg-9 view_slider recommended">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="sorting-div d-flex align-items-center justify-content-between">
                            <p class="mb-2">24/7 Services available</p>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="inner-slider" style="border-top: 1px solid #ccc; padding: 5px; background-color: #f9f9f9; border-radius: 10px;">
                            <div class="inner-wrapper" style="max-width: 800px; margin: 0 auto; text-align: center;">
                                <a href="#">
                                    <img class="img-fluid" src="{{ asset('assets/images/sponsors/SIAO-Logo.png') }}" style="background-color: black;" />

                                </a>
                                <div>
                                    <a href="https://siao.ng/" target="_blank" style="text-decoration: none; color: #333;">
                                        <span style="display: block; margin-bottom: 10px;">
                                            <h2 style="font-size: 24px; font-weight: bold; color: #405189;">SIAO Nigeria</h2>
                                            <!-- <p style="font-size: 18px; font-weight: bold; color: #555;">With a professional staff strength of over 100 highly qualified
                                                 and dedicated personnel, we pride ourselves on being Nigeria’s largest indigenous 
                                                 professional services firm.</p> -->
                                        </span>
                                    </a>
                                </div>
                                <div>
                                    <h3 style="background-color: #405189; padding: 15px; color: white !important; font-weight: bold; border-radius: 5px;">
                                        With a professional staff strength of over 100 highly qualified
                                        and dedicated personnel, we pride ourselves on being Nigeria’s largest indigenous
                    ...
                    <div class="col-md-4">
                        <div class="inner-slider" style="border-top: 1px solid #ccc; padding: 5px; background-color: #f9f9f9; border-radius: 10px;">
                            <div class="inner-wrapper" style="max-width: 800px; margin: 0 auto; text-align: center;">
                                <a href="#">
                                    <img class="img-fluid" src="{{ asset('assets/images/sponsors/logo-adp.svg') }}" />

                                </a>
                                <div>
                                    <a href="https://www.adp.com//" target="_blank" style="text-decoration: none; color: #333;">
                                        <span style="display: block; margin-bottom: 10px;">
                                            <h2 style="font-size: 24px; font-weight: bold; color: #405189;">ADP</h2>
                                            <!-- <p style="font-size: 18px; font-weight: bold; color: #555;">The Most Preferred Hotel in West Africa</p> -->
                                        </span>
                                    </a>
                                </div>
                                <div>
                                    <h3 style="background-color: #405189; padding: 15px; color: white !important; font-weight: bold; border-radius: 5px;">
                                        You need comprehensive HR solutions that empower your people and unlock
                            ...
                            <div class="inner-wrapper">
                                <div class="d-flex align-items-center">
                                    <span class="seller-image">
                                        <img class="img-fluid"
                                            src="{{ asset("assets/images/user/s2.png") }}"
                                            alt='' />
                                    </span>
                        ...
                        <div class="inner-slider">
                            <div class="inner-wrapper">
                                <div class="d-flex align-items-center">
                                    <span class="seller-image">
                                        <img class="img-fluid"
                                            src="{{ asset("assets/images/user/s3.png") }}"
                                            alt='' />
                                    </span>
                                    <span class="seller-name">
                                        <a href="#">Stave Martin</a>
                        ...
                        <div class="inner-slider">
                            <div class="inner-wrapper">
                                <div class="d-flex align-items-center">
                                    <span class="seller-image">
                                        <img class="img-fluid"
                                            src="{{ asset("assets/images/user/s4.png") }}"
                                            alt='' />
                                    </span>
                                    <span class="seller-name">
                                        <a href="#">Stave Martin</a>
                        ...
                        <div class="inner-slider">
                            <div class="inner-wrapper">
                                <div class="d-flex align-items-center">
                                    <span class="seller-image">
                                        <img class="img-fluid"
                                            src="{{ asset("assets/images/user/s5.png") }}"
                                            alt='' />
                                    </span>
                                    <span class="seller-name">
                                        <a href="#">Stave Martin</a>
                        ...
                        <div class="inner-slider">
                            <div class="inner-wrapper">
                                <div class="d-flex align-items-center">
                                    <span class="seller-image">
                                        <img class="img-fluid"
                                            src="{{ asset("assets/images/user/s6.png") }}"
                                            alt='' />
                                    </span>
                                    <span class="seller-name">
                                        <a href="#">Stave Martin</a>
                    ...
                    <div class="col-md-4">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset("assets/images/list/v7.png") }}" />
                        </a>
                        <div class="inner-slider">
                            <div class="inner-wrapper">
                                <div class="d-flex align-items-center">
                                    <span class="seller-image">
                                        <img class="img-fluid"
                                            src="{{ asset("assets/images/user/s7.png") }}"
                                            alt='' />
                                    </span>
                                    <span class="seller-name">
                                        <a href="#">Stave Martin</a>
                    ...
                    <div class="col-md-4">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset("assets/images/list/v8.png") }}" />
                        </a>
                        <div class="inner-slider">
                            <div class="inner-wrapper">
                                <div class="d-flex align-items-center">
                                    <span class="seller-image">
                                        <img class="img-fluid"
                                            src="{{ asset("assets/images/user/s8.png") }}"
                                            alt='' />
                                    </span>
                                    <span class="seller-name">
                                        <a href="#">Stave Martin</a>
                        ...
                        <div class="inner-slider">
                            <div class="inner-wrapper">
                                <div class="d-flex align-items-center">
                                    <span class="seller-image">
                                        <img class="img-fluid"
                                            src="{{ asset("assets/images/user/s9.png") }}"
                                            alt='' />
                                    </span>
                                    <span class="seller-name">
                                        <a href="#">Stave Martin</a>
