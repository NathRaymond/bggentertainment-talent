    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="mt-0 mb-3 text-white">Services</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 view_slider recommended">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset("assets/images/sponsors/kayi.webp") }}" />
                        </a>
                        <div class="inner-slider">
                            <div class="inner-wrapper">
                                <div class="d-flex align-items-center">
                                    <a href="https://app.kayi.ng/signup" target="_blank">
                                        <!-- <span class="seller-image">
                                            <img class="img-fluid"
                                                src="{{ asset("assets/images/user/s1.png") }}"
                                                alt='' />
                                        </span> -->
                                        <span class="">
                                            <a href="https://app.kayi.ng/signup" target="_blank">KAYI BANKING</a>
                                ...
                                <h3>
                                    Our mission at Kayi is to revolutionize contemporary banking...
