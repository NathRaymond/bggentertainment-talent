    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="mt-0 mb-3 text-white">Vendor Services</h1>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="filters-card-body card-shop-filters">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="cb2">Vendor Services</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                    ...
                    <div class="col-md-4">
                        <div class="inner-slider" style="border-top: 1px solid #ccc; padding: 5px; background-color: #f9f9f9; border-radius: 10px;">
                            <div class="inner-wrapper" style="max-width: 800px; margin: 0 auto; text-align: center;">
                                <a href="#">
                                    <img class="img-fluid" src="{{ asset('assets/images/sponsors/graceful.png') }}" />

                                </a>
                                <div>
                                    <a href="https://www.ekohotels.com/" target="_blank" style="text-decoration: none; color: #333;">
                                        <span style="display: block; margin-bottom: 10px;">
                                            <h2 style="font-size: 24px; font-weight: bold; color: #405189;">Graceful Solutions Real Estate & Construction</h2>
                                ...
                                <div>
                                    ...
                                    The Graceful Management System (GMS) is a cloud-based enterprise resource planning service for the construction industry.
                                    </h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="inner-slider" style="border-top: 1px solid #ccc; padding: 5px; background-color: #f9f9f9; border-radius: 10px;">
                            <div class="inner-wrapper" style="max-width: 800px; margin: 0 auto; text-align: center;">
                                ...
                                <div>
                                    <a href="https://www.ekohotels.com/" target="_blank" style="text-decoration: none; color: #333;">
                                        <span style="display: block; margin-bottom: 10px;">
                                            <h2 style="font-size: 24px; font-weight: bold; color: #405189;">Graceful Solutions Imports & Exports</h2>
                                            <!-- <p style="font-size: 18px; font-weight: bold; color: #555;">The Most Preferred Hotel in West Africa</p> -->
                                        </span>
                                    </a>
                                </div>
                                <div>
                                    <h3 style="background-color: #405189; padding: 15px; color: white !important; font-weight: bold; border-radius: 5px;">
                                    Discover Graceful International Company export import data, contact details, and strategic insights to enhance your global connections.
                                    </h3>
                                </div>
                            </div>
                        </div>
