            ...
            <div class="row">
                ...
                <div class="col-lg-8 right">
                    <div class="p-4 bg-white rounded shadow-sm mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <h6 class="font-weight-bold">BUSINESS BANKING PACKAGE</h6>
                                <p class="text-muted">It entails:
                                </p>
                                <p>POS machine (Point of Sale)</p>
                                <p>Financial literacy class</p>
                                <p>Tax services</p>
                                <p>Payroll services</p>
                                <a href="https://app.kayi.ng/sign-up" target="_blank">
                                    <button class="btn btn-outline-success" type="submit"> Activate Package</button></a>
                            </div>
                            <div class="col-lg-4">
                                <div class="display-4 my-2">
                                ...
                                <h6 class="font-weight-bold">WOMEN WITH CHILDREN BANKING PACKAGE
                                </h6>
                                <p class="text-muted">It entails:
                                </p>
                                <p>POS machine (Point of Sale)</p>
                                ...
                                <p>Tax services</p>
                                <p>Payroll services</p>
                                <p>Child care and transportation package service
                                </p>
                                <a href="https://app.kayi.ng/sign-up" target="_blank">
                                    <button class="btn btn-outline-success" type="submit"> Activate Package</button>
                                </a>
                            </div>
                            <div class="col-lg-4">
                                <div class="display-4 my-2">
                                ...
                                <h6 class="font-weight-bold">AGRIBUSINESS BANKING PACKAGE</h6>
                                <p>Business bank account</p>
                                <p>POS machine (Point of Sale)</p>
                                <p>Farmer’s card (4% discount on purchases)</p>
                                <p>OPTIONAL
                                    <br>
                                    <b>
                                        Agribusiness loan at 12% interest rate
                                    </b>
                                </p>
                                <a href="https://app.kayi.ng/sign-up" target="_blank">
                                    <button class="btn btn-outline-success" type="submit"> Activate Package</button>
                    ...
                    <div class="p-4 bg-white rounded shadow-sm my-3">
                        <h6 class="mb-2 font-weight-bold">How to build your success on BGG Entertainment in 3 steps
                        </h6>
                        <p class="m-0">The key to your success on BGG Entertainment is the brand you build for yourself through your BGG Entertainment reputation. We gathered some tips and resources to help you become a leading seller on BGG Entertainment.
                        </p>
                    </div>
                    <div class="p-4 bg-white rounded shadow-sm mb-3">
                        <h5 class="mb-4 font-weight-bold text-center">Take these steps to become a top seller on BGG Entertainment
                        </h5>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="display-4 my-2">
